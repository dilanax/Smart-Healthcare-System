...
public class DataLoader implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        if (doctorRepository.count() == 0) {
            doctorRepository.save(new Doctor(0, "John", "Smith", "Cardiology", "Cardiology", "Asiri Central Hospital",
                ...
                5.0, 10, 5000));
            doctorRepository.save(new Doctor(0, "Emily", "Johnson", "Neurology", "Neurology", "Colombo Hospital",
                ...
                4.8, 8, 3500));
            doctorRepository.save(new Doctor(0, "David", "Williams", "Orthopedics", "Orthopedics", "Kandy Medical Center",
                ...
                4.9, 12, 4200));
            doctorRepository.save(new Doctor(0, "Sarah", "Brown", "Pediatrics", "Pediatrics", "Galle Hospital",
