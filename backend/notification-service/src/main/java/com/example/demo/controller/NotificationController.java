...
public class NotificationController {
    ...
    @PostMapping("/events/appointment-success")
    public ApiResponse<List<Notification>> sendAppointmentOrConsultationSuccess(@Valid @RequestBody AppointmentNotificationEventRequest request) {
        return ApiResponse.success(
                "Appointment/consultation confirmations were processed.",
                notificationService.sendAppointmentOrConsultationConfirmation(request)
        );
    }
